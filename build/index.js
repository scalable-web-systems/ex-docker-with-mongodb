...
var initDB = function () { return __awaiter(void 0, void 0, void 0, function () {
    var uri, mongo, products, cur, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                return [4 /*yield*/, mongo.db('admin').command({ ping: 1 })];
            case 3:
                _a.sent();
                console.log('Connected successfully to server');
                products = mongo.db().collection('products');
                cur = products.find();
                cur.forEach(function (d) { return console.log(d); });
                return [3 /*break*/, 5];
            case 4:
                e_1 = _a.sent();
                console.error(e_1);
